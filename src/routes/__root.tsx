...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shis Ousman — Student & Founder" },
      { name: "description", content: "Shis Ousman — student, founder and creative based in Messina, Sicily. Building immersive stays, cinematic spaces and digital experiences." },
      { property: "og:title", content: "Shis Ousman — Student & Founder" },
      { property: "og:description", content: "Shis Ousman — student, founder and creative based in Messina, Sicily. Building immersive stays, cinematic spaces and digital experiences." },
...
// keep Outlet import used in Layout
void Outlet;
